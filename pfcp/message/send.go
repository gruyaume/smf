...
func SendHeartbeatRequest(remoteAddress *net.UDPAddr, upNodeID pfcpType.NodeID) error {
...
func sendHeartbeatRequestToAdapter(remoteAddress *net.UDPAddr, message pfcp_message.Message, upNodeID pfcpType.NodeID) {
...
func SendPfcpAssociationSetupRequest(remoteAddress *net.UDPAddr, upNodeID pfcpType.NodeID) error {
...
func sendAssociationSetupRequestToAdapter(remoteAddress *net.UDPAddr, message pfcp_message.Message, sequenceNumber uint32, upNodeID pfcpType.NodeID) {
	rsp, err := SendPfcpMsgToAdapter(upNodeID, message, remoteAddress)
	if err != nil {
...
func SendPfcpAssociationReleaseResponse(remoteAddress *net.UDPAddr, upNodeID pfcpType.NodeID, cause uint8) error {
...
func sendSessionEstablishmentRequestToAdapter(remoteAddress *net.UDPAddr, message pfcp_message.Message, upNodeID pfcpType.NodeID) {
	adapter.InsertPfcpTxn(message.Sequence(), &upNodeID)
	rsp, err := SendPfcpMsgToAdapter(upNodeID, message, remoteAddress)
	if err != nil {
...
func sendSessionModificationRequestToAdapter(upNodeID pfcpType.NodeID, message pfcp_message.Message, upaddr *net.UDPAddr) {
...
func SendPfcpSessionDeletionRequest(remoteAddress *net.UDPAddr, upNodeID pfcpType.NodeID, ctx *smf_context.SMContext) (uint32, error) {
...
func sendSessionDeletionRequestToAdapter(upNodeID pfcpType.NodeID, message pfcp_message.Message, upaddr *net.UDPAddr) {
...
func SendPfcpMsgToAdapter(upNodeID pfcpType.NodeID, msg pfcp_message.Message, addr *net.UDPAddr) (*http.Response, error) {
	// get IP
	ip_str := GetLocalIP()
